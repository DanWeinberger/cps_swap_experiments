...
mod2 <- lm(adj_max_od ~ 1 + Serotype*Background ,   data=comp2)
...
mod1 <- glm.nb(carriage ~ beta_back15bc +study + vt , data=carr2)
summary(mod1)

mod1 <- glm.nb(carriage ~ beta_back22f +study +vt, data=carr2)
summary(mod1)
