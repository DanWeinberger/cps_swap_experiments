...
## Summary
These plots represent pangenomes created based on the sequenced strains. The heatmaps indicate whether a particular strain has gained a gene (yellow) or lost a gene(dark blue) compared to the reference
